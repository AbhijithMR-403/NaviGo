...
function UserMap() {
    ...
    return (
        <div className='relative bg-gray-100'>
            ...
            <div className='bg-blue-100 h-full w-full sm:w-96 absolute z-10'>
                    ...
                    <div>
                        ...
                        <select id="countries" onChange={(e) => {
                            if (e.target.value == 'null') {
                                ...
                                setStartStop(BusStopList.find((val) => e.target.value == val.id))
                ...
                {RouteList.length == 0 ? <div className='text-center p-4 mt-6 font-bold'>No bus Available in this route</div> :
                    <div style={{ height: '550px' }} className='overflow-y-scroll'>
