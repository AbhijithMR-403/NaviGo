  ...
  return (
    <div>
      ...
      <form class="form" method='POST' onSubmit={handleLoginSubmit}>
        ...
        <p class="p">Don't have an account? <Link to={'/auth/signup'}><span class="span">Sign Up</span></Link>
        ...
        <div class="flex-row">
          ...
          {/* <button className="btn google">
            ...
            C103.821,274.792,107.225,292.797,113.47,309.408z"></path>
              <path style={{ fill: '#518EF8' }} d="M507.527,208.176C510.467,223.662,512,239.655,512,256
