...
function UserProfile() {
    ...
    useEffect(() => {
        console.log('this is the use id --', localStorage.getItem('access'));
        ...
        <div>
            <div className="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-white rounded-xl">
                ...
                {/* <div className="col-span-full xl:col-auto">
                    <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-400 sm:p-6 dark:bg-gray-800">
                            ...
                            <div className="grid grid-cols-6 gap-6">
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    ...
                                    <input
                                        ...
                                        id="address"
                                        className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        defaultValue={UserDetails.user ? UserDetails.address : ''}
                                        required=""
                                    />
                                </div> */}
                                <div className="col-span-6 sm:col-span-3">
                                ...
                                {/* <div className="col-span-6 sm:col-span-3">
                                    ...
                                    <input
                                        ...
                                        defaultValue={UserDetails ? UserDetails.company_name : ''}
                                        required=""
                                    />
                                </div> */}
                                ...
                                {/* <div className="col-span-6 sm:col-span-3">
                                    ...
                                    <input
                                        ...
                                        className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder={123456}
                                        defaultValue={UserDetails.user ? UserDetails.pincode : ''}
                                        required=""
                                    />
                                </div> */}
