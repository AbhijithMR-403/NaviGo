...
function StopListModal({handleSubmit, origin, waypoints, destination, setChosen}) {
    return (
        ...
        <div className="absolute w-full md:w-3/4 h-full backdrop-blur-sm z-50">
            <ol class="relative pb-4 rounded-xl top-1/4 left-1/4 w-1/2 sm:w-1/3 text-gray-900 border-s border-gray-200 dark:border-gray-700 bg-slate-200 ">
                ...
                return (<li class="mb-10 ms-6 flex ">
                    <span class="absolute flex items-center justify-center w-6 h-6 bg-green-200 rounded-full  ring-1 ring-white dark:ring-gray-900 dark:bg-black">
                    ...
                    <h3 class="font-medium pl-12 leading-tight ">{res.stop_name}</h3>
                </li>)
                })}

                {/* Ending Points */}
                <li class="mb-10 ms-6 flex">
                    <span class="absolute flex items-center justify-center w-6 h-6 bg-green-200 rounded-full ring-white dark:ring-white dark:bg-gray-200">
                ...
                <button onClick={()=>handleSubmit()} type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-1.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Confirm</button>
